...
class Comment(models.Model):
    ...
    :model:`auth.User` and :model:`post.Post`
    """
...
class Like(models.Model):
    """
    Stores a single like entry related to
    :model:`auth.User` and :model:`post.Post` and
...
# if the user does not have a profile, one is created
...
# adds get_or_create_profile(user) method to the User class/model
